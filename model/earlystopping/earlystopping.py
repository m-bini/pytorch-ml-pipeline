...
class EarlyStopping:
    ...
    def __init__(self, patience=np.inf, mode="max", delta=0.001, checkpoint_path='checkpoint.pth'):
        """
        Parameters
        ----------
        ...
        self.delta = delta
        self.patience = np.min((patience, np.inf)) # if no patience is provided, set it to infinite
